...
//ANSWER: There is an error since I have to change the data type of my new keys for me dictionaries for year from String to Int.
...
//    
//    if let name = aMovie["name"] as? String, year = aMovie["year"] as? Int, cast = aMovie["cast"] as? [String] {
//        aMovie.removeValueForKey("year")
//        moviesByYear[year] = aMovie
//    }
//}
//print(moviesByYear)
//
...
//for var aMovie in movies {
//    
//    if let genre = aMovie["genre"] as? String, year = aMovie["year"] as? Int, cast = aMovie["cast"] as? [String] {
