...
for i in 0...3 {
if var name = allmovies["name"] as? String, year = allmovies["year"] as? Int, cast = allmovies["cast"] as? [String] {
    print("\(year): \(name)")
...
print(aMovie["year"]!, aMovie["name"]!, bMovie["name"]!)
