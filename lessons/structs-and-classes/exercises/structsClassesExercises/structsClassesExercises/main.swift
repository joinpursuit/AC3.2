...
//    if let name = movieDict["name"] as? String, year = movieDict["year"] as? Int {
//        let movie = Movie()
//        movie.name = name
//        movie.year = year
...
//    
//    
//    if let cast = movieDict["cast"] as? [String] {
...
//    }
//    
//    if let description = movieDict["description"] as? String {
//        let movie = Movie()
...
//    }
    ...
    for m in movies {
        if let title = m["name"] as? String, let year = m["year"] as? Int, let genre = m["genre"] as? String, let cast = m["cast"] as? [String], let description = m["description"] as? String {
            let movie = Movie()  //This is creating an instance
            movie.name = title
            movie.year = year
            movie.genre = genre
            movie.cast = cast
...
//start: Int, name: String, terms: Int, born: Int, died: Int?
var p = President(start: 1200, name: "Genghis Khan", terms: 8, born: 1100, died: 1260)
p = President(start: 1200, years: 56, name: "Genghis Khan Jr", born: 1240, died: 1249)
//p = President(terms: 5, electedYear: 1248, name: "Ms Khan", born: 1230, died: 1299)
