...
let Prezzy = President(start: 1902, terms: 3, name: "That guy", born: 1875, died: 1955)
print(Prezzy)
...
for movieDict in movies {
    ...
    {
        let movie = Movie(name: "American Sniper", year: 2014, genre: "drama", cast: ["Bradley Cooper", "Sienna Miller", "Kyle Gallner"], description: "Navy S.E.A.L. sniper Chris Kyle\"s pinpoint accuracy saves countless lives on the battlefield and turns him into a legend. Back home to his wife and kids after four tours of duty, however, Chris finds that it is the war he can\"t leave behind.")
//        movie.name = name
//        movie.year = year
//        movie.cast = cast
//        movie.genre = genre
