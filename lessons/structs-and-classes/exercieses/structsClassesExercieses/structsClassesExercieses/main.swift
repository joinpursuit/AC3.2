...
var movieArray = [Movie]()                  // we need save it to array


for movieDict in movies{                    //movies -- dictionary name
   
    if let name = movieDict["name"]as? String,          // iterate if they are exist
        year = movieDict["year"] as? Int,
        genre = movieDict["genre"] as? String,
        cast = movieDict["cast"] as? [Actor],
        description = movieDict["description"]as? String
    {
        
        var movie = Movie()                    //create the object iside the loop
        movie.name = name                       //cretae object elements
        movie.year = year
        movie.genre = genre
        movie.cast = cast
        movie.description = description
        movieArray.append(movie)                //add elements in to the array
        
        print("Name: \(movie.name) Year: \(movie.year) Cast: \(movie.cast) Description: \(movie.description)")
...
ronaldReagan.name = "Ronal Reagan"
