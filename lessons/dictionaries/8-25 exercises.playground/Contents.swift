...
var citiesDict = ["China":"Beijing", "Philippines": "Manilla", "Korea": "Seoul"]
...
//c) Translate at least 3 of the capital names (values) into another language

citiesDict["China"] = "Not Beijing"
citiesDict["Philippines"] = "Vanilla"
citiesDict["Korea"] = "Not North Korea"
print(citiesDict)
...
//d) Make a key called "sumUpToSix" and set its value equal to the sum of the values "One", "Two", "Three", "Four", "Five" and "Six"

var sumThree = 0
for keys in someDict.keys {
    if keys != "Seven" && keys != "productUpToSeven" {
        sumThree += someDict[keys]!
    }
}
print(sumThree)

someDict["sumUpToSix"] = sumThree
...
var americanLit: [String: Float] = ["Mark Twain": 8.9, "Nathaniel Hawthorne" : 5.1, "John Steinbeck" : 2.3, "C.S. Lewis" : 9.9, "Jon Krakaur" : 6.1]
