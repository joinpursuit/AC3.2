...
var citiesDict = ["USA":"DC", "Japan": "Tokyo", "Korea":"Seoul"]
//b) Add two more countries to your dictionary
citiesDict["C4Q"] = "Headquarters"
citiesDict["China"] = "Beijing"
//c) Translate at least 3 of the capital names into another language
citiesDict["USA"] = "Chinese DC"
citiesDict["C4Q"] = "Chinese Headquarters"
//2)
...
var product = 1
for productUpToSeven in someDict.values {
    product *= productUpToSeven
}
...
var sum = 0
for sumUpToSix in someDict.values where sumUpToSix != 49 {
    sum += sumUpToSix
}
...
if let value = explicitDict["John Steinbeck"] {
    print(value)
}
explicitDict["Erik Larson"] = 9.2
if explicitDict["Jon Krakaur"] > explicitDict["Mark Twain"] {
    print("Jon Krakaur")
} else {
    print("Mark Twain")
}
