...
var citiesDict = ["USA": "Washington DC", "Ecuador": "Quito", "India": "New Dalhi"]
//b) Add two more countries to your dictionary
citiesDict["Japan"] = "Tokyo"
citiesDict["England"] = "London"
print(citiesDict)
//c) Translate at least 3 of the capital names into another language
citiesDict.updateValue("Washingtone", forKey: "USA")
citiesDict.updateValue("New Dili", forKey: "India")
citiesDict.updateValue("Quit", forKey: "Ecuador")
print(citiesDict)
//2)
...
var sumUpToSix = 0
for value1 in someDict.values{
    
    //    while value1[0]...value1[6]{
    //        sumUpToSix += value1
    //        break
    //    }
}
...
for (k, v) in someDict{
    someDict.updateValue(v+2, forKey: k)
}
print(someDict)
...
/*
 ...
 “Jon Krakaur” - 6.1
 */
var score: [String:Float] = ["Mark Twain": 8.9, "Nathaniel Hawthorne": 5.1, "John Steinbeck": 2.3, "C.S. Lewis": 9.9, "Jon Krakaur": 6.1]
...
print(score["John Steinbeck"]!)
score["Erik Larson"] = 9.2
if score["John Steinbeck"] > score["Mark Twain"] {
    print("John had a higher score!")
} else {
