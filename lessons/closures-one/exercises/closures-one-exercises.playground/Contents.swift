...
print ( closureSeven ( [34,2,421,32,200], 7) )
...
//6b. Sort myArray in des,cending order by defining the constant descendingOrder below.

//let mySecondSortedArray = myArray.sort(descendingOrder)
//let descendingOrder =

let descendingOrfer = myArray.sort({$0>$1})
...
let sortedArrayOfArrays = arrayOfArrays.sort { (a:[Int], b:[Int]) -> Bool in
                        a[2] < b[2]
}
