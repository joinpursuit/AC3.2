...
var longestCharacter = { (a: String, b: String) -> Int in
...
longestCharacter("hello", "Bye")

//5a. Create a closure that takes an array of Int as input and returns the largest element in the array
var myArray2 = [1,4,5,70]


//var largestElementInArray = { (a: [Int]) -> Int in
//    var max = a.maxElement()
//    return max!
//    }
//
//largestElementInArray(myArray2)
...
var xthLargestelement = { ( a: [Int], x: Int) -> Int in
    var sorted = a.sort(>)
    var xthLargest = sorted[x-1]
    return xthLargest
}


print(xthLargestelement(myArray2, 1))



//5c.  Rewrite 5b and add handling for cases where x >= the count of the array (Hint: Use use optionals)
//var myArray3 = [1,4,5,70]
//
//var xthLargestelement2 = { ( a: [Int], x: Int) -> Int? in
//    var sorted = a.sort(>)
//    var xthLargest = sorted[x-1]
//    return xthLargest
//}
...
let sortedArray = arrayOfArrays.sort{ (a: [Int], b: [Int]) -> Bool in
...
//var arrayOfArrays2 = [[3,65,2,4],[25,3,1,6],[245]]
//
//let sortedArray2 = arrayOfArrays.sort{ (a: [Int], b: [Int]) -> Bool in
//    var sA = a[2]
//    var sB = b[2]
//    
//    if a.count < 4 {
