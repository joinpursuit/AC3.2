...
var closureWithTwoStrings = { (a: String, b: String) -> Int in
...
print(closureWithArrayOfInt(arrayOfInt))
...
//var closureArrayOfIntAndaVariableX = { (array: [Int], x: Int) -> Int
//    
//}
...
let decendingOrder = {(a: Int, b: Int) -> Bool in
    return (a > b)
}
